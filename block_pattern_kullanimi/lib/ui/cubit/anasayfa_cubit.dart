...
class AnasayfaCubit extends Cubit<int> {
  ...
  void toplamaYap(String alinanSayi1, String alinanSayi2){
    emit(mrepo.toplamaYap(alinanSayi1, alinanSayi2)); //Tetikleme ve veri gönderme işlemlerini yapmaya yarar.
  }

  void carpmaYap(String alinanSayi1, String alinanSayi2){
    emit(mrepo.carpmaYap(alinanSayi1, alinanSayi2)); //Tetikleme ve veri gönderme işlemlerini yapmaya yarar.
  }
